...
let array_objectlist = ()=>({key1:'value1',key2:'value2',key3:'value3'});
console.log(array_objectlist())
...
let array_sumAndProduct = (a,b)=>{let sum=a+b;let product=a*b;return[sum,product]} 
console.log(array_sumAndProduct(3, 9));
...
let arr_message = (name) => `Hello, ${name}`
console.log(arr_message('Allie'))
...
// its current surrounding scope 
// 3. Explain why "this" is different when an arrow function is used.
// becase in the constructor this refer to the object but when using arrow function its will refer to 
// its surrounding scope so when using the arrow function this will no longerrefer to the object
